...
def main(board, computer, player, game_round):
    ...
    # selection depends on game_round
    if game_round == 0:  # Computer is player 1
        # select a corner as first move
        select = random.choice(corners)
        return select + 1
    elif game_round == 1:  # Computer is player 2
        ...
        for i in corners:
            ...
            return select + 1
    elif game_round == 2:  # Computer is player 1
        ...
        return select + 1
    elif game_round == 3:  # Computer is player 2
        ...
        select = random.choice(available_slots_corners)
        return select + 1
    elif game_round == 4 or game_round == 5:  # Computer is player 1 or 2
        ...
        return select + 1
    else:   # rest of the game_rounds. Computer is player 1 or 2
        # check if computer can win
        possible_win = check_possible_win(board.copy(), computer, available_slots)
        if possible_win != "False":
            return possible_win + 1
